  ...
  return (
    <main>
      <Section marginBottom={true} marginTop={true}>
        <PageTitle title="Terms of Use of MobiPost" />
        <div className="flex flex-col gap-y-4">
          <div>
            <h2>Last Updated: 05.04.24 </h2>
            <p>
              Thank you for your interest in MobiPost. The following terms
              govern your use of our website. By accessing MobiPost, you agree
          ...
          <div>
            ...
            <p>
              You agree to use MobiSite only for lawful purposes and in
          ...
          <div>
            ...
            <p>
              The content and visual elements on MobiSite, including but
              not limited to text, images, logos, and videos, are the property
              of MobiSite or its licensors and are protected by copyright
          ...
          <div>
            ...
            <p>
              To the fullest extent permitted by applicable law, MobiSite and
